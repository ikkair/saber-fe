package com.desti.saber.LayoutHelper.PickupTrashesList;
...
public class PickupTrashesList {
    ...
    public void startPopUp(TrashDetailDTO[] trashDetailDTOS, PickupDetailDto pickupDetailDto){
        close();
        ...
        trashListTable.addCell(singlePickupDetail.cell("Foto Sampah"));
        trashListTable.addCell(singlePickupDetail.cell("Type Sampah"));
        trashListTable.addCell(singlePickupDetail.cell("Berat Sampah (KG)"));
        trashListTable.addCell(singlePickupDetail.cell("Total Harga Sampah"));
        trashListTable.addCell(singlePickupDetail.cell("Keterangan"));
        ...
        for (TrashDetailDTO trashDetailDTO : trashDetailDTOS) {
            addSingleTrashView(trashDetailDTO, new SuccessImage() {
                ...
                public void success(InputStream inputStream) {
                    ...
                    trashListTable.addCell(singlePickupDetail.cell(IDRFormatCurr.currFormat(trashDetailDTO.getAmount())));
